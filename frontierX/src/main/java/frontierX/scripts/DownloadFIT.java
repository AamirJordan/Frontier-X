...
public class DownloadFIT extends BasicSettings {
...
//				System.out.println("Invalid user name. Please enter valid user name");
			...
			try {
				hp.clickOnDownloadFIT();
				System.out.println("FIT File option was clicked for " + aut + " user");
					
			} catch (Exception e) {
				Assert.fail("FIT File option is unavailable to download for " + aut + " user");
			}
